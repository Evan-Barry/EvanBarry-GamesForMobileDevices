...
public class InitializeAdsScript : MonoBehaviour, IUnityAdsListener
{
    ...
    public Button useHintButton, getHintButton;
    ...
    void Start()
    {
        ...
        {
            adSet = true;//Use Unity Ads
        }
        else
        {
            adSet = false;//Use Google Ads
        }
        
        getHintButton = GameObject.Find("getHintButton").GetComponent<Button>();
        useHintButton = GameObject.Find("useHintButton").GetComponent<Button>();
        ...
        if(getHintButton) 
        {
            ...
            {
                //Unity Rewarded
                getHintButton.onClick.AddListener(showRewardedVideo);
            ...
            else
            {
                ...
                getHintButton.onClick.AddListener(showGoogleRewardedVideo);
            }
        }
    ...
    void Update()
    {
        if(!iAdShown)
        {
            ...
            if(this.googleInterstitial != null && this.googleInterstitial.IsLoaded())
            {
        ...
        if(Advertisement.IsReady(mySurfacingIdRewarded) && !getHintButton.IsInteractable())
        {
            Debug.Log("Make hint button interactable");
    ...
    public void OnUnityAdsReady (string surfacingId) 
    {
        ...
        if (surfacingId == mySurfacingIdRewarded || surfacingId == mySurfacingIdBanner) {
            ...
            useHintButton.interactable = Advertisement.IsReady(mySurfacingIdRewarded);
        }
    }
